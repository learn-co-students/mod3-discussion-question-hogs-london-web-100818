...
const SHORTRANGE = 500    // the delay range until non-selected elements begin their animation
const LONGRANGE = 1000     // the delay range until the selected element begins its animation
...
const PIGGYSMALLSHAIKULINEGROUP = Array.from(document.getElementsByClassName('piggy-smalls-group haiku-line'))
const TRUFFLESHUFFLEHAIKULINEGROUP = Array.from(document.getElementsByClassName('truffleshuffle-group haiku-line'))
const RAINBOWDASHHAIKULINEGROUP = Array.from(document.getElementsByClassName('rainbowdash-group haiku-line'))